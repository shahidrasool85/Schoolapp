    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/school/term-dates", label: "Term dates", permissions: ["academic.structure.manage"] },
      ...
      },
      {
        ...
        children: [
          { href: "/school/finance", label: "Overview", exact: true, permissions: ["finance.reports.read", "finance.charges.read", "finance.invoices.read", "finance.read"] },
          { href: "/school/finance/student-fees", label: "Student fees", permissions: ["finance.invoices.read", "finance.read", "finance.reports.read"] },
          { href: "/school/finance/invoices", label: "Invoices", permissions: ["finance.invoices.read", "finance.read"] },
          { href: "/school/finance/payments", label: "Payments", permissions: ["finance.payments.read", "finance.transactions.read", "finance.read"] },
          { href: "/school/finance/receipts", label: "Receipts", permissions: ["finance.payments.read", "finance.transactions.read", "finance.read"] },
          { href: "/school/finance/reports", label: "Reports", permissions: ["finance.accounts.read", "finance.read", "finance.reports.read"] },
          { href: "/school/finance/settings", label: "Settings", permissions: ["finance.settings.manage", "finance.manage"] },
          { href: "/school/finance/advanced", label: "Advanced", permissions: ["finance.invoices.read", "finance.read", "finance.fee_schedules.manage", "finance.billing_runs.manage"] },
        ],
      },
      {

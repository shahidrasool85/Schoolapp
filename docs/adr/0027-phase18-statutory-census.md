...
3. **Version, do not overwrite.** Regenerating a draft snapshot inserts `current_snapshot_version + 1`. Exported, superseded, archived, and finalised (`ready`) snapshots cannot be rewritten. Snapshot tables are INSERT-only for the app role.

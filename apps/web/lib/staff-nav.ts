      ...
      },
      {
        ...
        children: [
          { href: "/school/timetable", label: "Overview", exact: true, permissions: TIMETABLE_NAV_PERMISSIONS },
          {
            ...
            permissions: ["timetable.read", "timetable.manage_school"],
          },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { href: "/school/finance", label: "Overview", exact: true, permissions: ["finance.reports.read", "finance.charges.read"] },
          { href: "/school/finance/charges", label: "Charges", permissions: ["finance.charges.read", "finance.charges.manage"] },
          { href: "/school/finance/outstanding", label: "Outstanding", permissions: ["finance.charges.read", "finance.reports.read"] },
          { href: "/school/finance/transactions", label: "Transactions", permissions: ["finance.transactions.read"] },
          { href: "/school/finance/refunds", label: "Refunds", permissions: ["finance.refunds.manage", "finance.transactions.read"] },
        ],
      },
      {

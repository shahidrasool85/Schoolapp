...
**Current status:** Phase 3 parent and student web portals are implemented on the Phase 1–2 foundation (tenancy, RBAC, RLS, people, school structure). Admissions, LMS, AI, and mobile are not built yet.

...
- Migration `0048_email_delivery.sql` is additive on `mail_outbox`. `0049_email_delivery_hardening.sql` reapplies claim/supersede/expiry for databases that already ran the original 0048. Neither rewrites 0047 or earlier.

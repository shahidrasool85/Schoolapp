...
expect_page "/platform/schools/example"
expect_page "/school"
...
expect_page "/school/settings/admissions"
expect_page "/school/settings/admissions?template=admissions_enquiry_submission_confirmation"
expect_page "/school/settings/admissions?template=admissions_application_submission_confirmation"
...
expect_page "/admissions/enquiry/year-3-enquiry/confirmation/example"
expect_page "/admissions/embed/enquiry/year-3-enquiry/confirmation/example"
...
expect_page "/school/finance/student-fees"
expect_page "/school/finance/advanced"
expect_page "/school/finance/reports"
...
expect_page "/school/finance/settings?tab=general"
expect_page "/school/finance/settings?tab=documents"
expect_page "/school/finance/settings?tab=payment"
expect_page "/school/finance/settings?tab=vat"
expect_page "/school/finance/settings?tab=online-payments"
expect_page "/school/finance/settings?tab=notifications"
expect_page "/school/finance/settings?tab=not-a-tab"

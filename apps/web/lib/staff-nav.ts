    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/school/finance/fee-schedules", label: "Fee schedules", permissions: ["finance.invoices.read", "finance.fee_schedules.manage", "finance.read"] },
          { href: "/school/finance/invoices", label: "Invoices / Charges", permissions: ["finance.invoices.read", "finance.read"] },
          { href: "/school/finance/payments", label: "Payments", permissions: ["finance.payments.read", "finance.transactions.read", "finance.read"] },
          { href: "/school/finance/accounts", label: "Families / Accounts", permissions: ["finance.accounts.read", "finance.invoices.read", "finance.read"] },
          { href: "/school/finance/receipts", label: "Receipts", permissions: ["finance.payments.read", "finance.transactions.read", "finance.read"] },
          { href: "/school/finance/statements", label: "Statements", permissions: ["finance.accounts.read", "finance.read", "finance.reports.read"] },

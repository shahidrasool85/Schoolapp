...
7. **Filesystem remains valid.** This phase does not require AWS/S3. Production that uses the filesystem driver must set `OBJECT_STORAGE_FS_ROOT` to a persistent path outside the Git deploy directory.

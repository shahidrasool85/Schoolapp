...
- Engagement (`/school/engagement`) — rewards, achievements, competitions, early learning, year-group policy
...
- Students (open Amelia Khan — Overview / Attendance / Learning / Academic / Documents tabs, the permission-gated **Medication & dietary** tab: Cetirizine, Salbutamol inhaler, historical Amoxicillin, a staff-only barrier cream that is not parent-visible, nut-free diet, and Halal meat only. Internal nurse-cupboard notes stay on the admin view. The permission-gated Statutory tab: UPN `P201990100001`, EHCP provision E. Jack Brennan has no UPN for the data-quality error example; Priya Shah is missing ethnicity/language; Oliver Brooks joins 3 November 2026; Harper Quinn left 18 December 2026)
...
Sign in as the Greenwood **teacher** and open Teaching & Learning. You should see Year 3 work for 3A (and 3B subject work), with unsubmitted, submitted, marked, and resubmission-requested examples. Attendance → My registers should still show 3A, not the whole school. On Amelia Khan’s pupil record, the **Medication & dietary** tab shows operational fields (Salbutamol / nut-free / barrier cream) without internal cupboard notes; Yusuf’s record is not assigned. Communications should let the teacher create a class notice for 3A, not a whole-school broadcast. **Messages** should show Amelia Khan’s maths homework thread with Aisha Khan, not Yusuf’s office thread unless Hannah is a participant, and never Oak’s Niamh thread. **My Timetable** should show Hannah Cole’s 3A lessons (week of 7 September 2026 if today is before term) with Take attendance. **Activities** should show trips/clubs Hannah is assigned to (museum visit, chess club, football fixture), not school-wide management of every activity. **Engagement → Rewards** should let Hannah award a category to Amelia (3A) and not to an unrelated Year 4/5 pupil. Hannah cannot open school-wide Engagement settings.

Sign in as the Greenwood **parent** and open the parent portal (`/parent`). You should see Amelia Khan and Yusuf Khan, attendance, Learning (assignments/due/status; marks only when released to parents), released formal results, published reports, Notices, Calendar, **Medication / Dietary** on Amelia (Cetirizine, Salbutamol, nut-free, Halal — not internal notes and not the staff-only barrier cream), **Messages** (Amelia maths homework with an unread teacher reply, school-office holiday club, closed Yusuf lost-jumper thread; no other parent or Oak threads), **Activities** (Science Museum consent for Amelia, Chess Club waiting list for Amelia / confirmed for Yusuf, football fixture, cancelled pottery workshop), **Payments** (Amelia museum trip outstanding, Amelia replacement reading book, Yusuf chess club paid with receipt; no Oak charges), and notifications. Unreleased results, the draft spring report, and the staff-only briefing must not appear. Family calendar rows should name which child/class they relate to. Each child has a **Timetable** page; Amelia (3A) and Yusuf (5A Friday Maths) differ. On an outstanding charge, **Pay** opens the local demo checkout (success/fail/cancel). Success returns as pending until the signed fake-provider event settles the charge; a receipt then appears. **Rewards** for Amelia should show the Reading Star recognition and no internal teacher note. Parent-assisted Play is for Reception/KS1 year groups when enabled; Amelia is Year 3 so Aisha does not impersonate her student account.

Sign in as the Greenwood **student** (Student tab, username `amelia.khan`) and open My Learning (`/student/learning`) plus Results (`/student/results`), Notices, **Activities**, **Play & learn**, **Rewards**, and **Competitions**. You should see assigned work, student-released formal results, the whole-school welcome, and the Year 3 swimming notice. Medication administration details (dosage, schedule, who administers) must **not** appear on My profile or the student dashboard. Parent-only English reading, unreleased science, parents' evening booking copy, and staff-only notices must not appear. **My Timetable** should show only Amelia’s 3A lessons. Coding club taster allows student self-sign-up; the museum trip does not. Play & learn should offer the Year 3 maths challenge; submitting scores once and reloading must not double XP. Competitions may show the Greenwood House Reading Challenge as house totals, not a named whole-school pupil ranking.

Sign in as the Greenwood **School Admin** and open **Engagement**. Confirm settings (leaderboards on for house/class, individual ranking off), year-group policy (Reception–Y2 early learning and parent-assisted; Y3 challenges/competitions), reward categories, achievements, the house reading challenge, and the early-learning catalogue (Count the Apples, letter matching, Year 1/2 activities).
...
- AI question generation, PDF report cards, and mobile apps are **not built yet**. Formal assessments/results/reports are in Phase 8. Public admissions forms are in Phase 9. Announcements and the school calendar are in Phase 10. The school timetable is in Phase 12. Trips, clubs, and parent consent are in Phase 14. School charges and parent payments are in Phase 15 (local fake provider; no Stripe credentials required). Parent–teacher messaging is in Phase 16 (in-app only; no email/SMS). Phase 17 restyles the authenticated product; it does not add new workflows. Phase 18 adds statutory pupil/school data, a data-quality centre, census snapshots, and census-ready exports (not a DfE COLLECT product). Phase 19 adds rewards, achievements, house/class competitions with privacy controls, and early-learning practice (server-scored; not formal assessment). Phase 13 object storage is available for pupil, learning, pastoral, safeguarding, admissions, activity, and message files.
